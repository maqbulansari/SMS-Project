...
exports.StudentAdmission = async (req, res) => {
    try {
        ...
        const createschyear = await SchoolYearData.create({...req.body})
        const createyearlvlfee = await Year_lvl_fee_Data.create({...req.body,schoole_year_id:createschyear._id});
